...
const eventControllers = require('./controllers/index.js');
...
app.get('/events/new', eventControllers.formSubmit);
app.post('/events/new', eventControllers.formSubmit);
...
app.get('/event_details', indexControllers.event_details);
